...
/**
 * SQL migrado 1:1 desde "Reporte Giancarlo/Query.sql" (AR-03).
 * Las tablas temporales viven dentro del mismo batch (sp_executesql), por lo que
 * no contaminan otras corridas aunque la conexión vuelva al pool de Hikari.
 */
public final class SacaTuGarraQueries {

    private SacaTuGarraQueries() {
    }

    public static final String BASE_SACA_TU_GARRA = """
            SET NOCOUNT ON;
            declare @fech date =:corte
